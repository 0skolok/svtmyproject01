...
?><?$APPLICATION->IncludeComponent(
	...
	Array(
		...
		"SEF_FOLDER" => "/courses/",
		"SEF_MODE" => "Y",
		"SEF_URL_TEMPLATES" => Array("compare"=>"","element"=>"#SECTION_CODE#/#ELEMENT_CODE#/","section"=>"/courses/#SECTION_CODE#/","sections"=>"","smart_filter"=>"#SECTION_CODE#/filter/#SMART_FILTER_PATH#/apply/"),
		"SET_LAST_MODIFIED" => "N",
		"SET_STATUS_404" => "N",
		"SET_TITLE" => "Y",
		"SHOW_404" => "N",
