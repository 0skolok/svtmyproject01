...
$MESS ['SOA_TEMPL_ORDER_SUC1'] = "Вы можете следить за выполнением своего заказа в <a href=\"#LINK#\">Персональном разделе сайта</a>. Обратите внимание, что для входа в этот раздел вам необходимо будет ввести E-Mail и пароль пользователя сайта.";
$MESS ['SOA_TEMPL_ORDER_SUC_PASS'] = "Если вы не регистрировались до оформления заказа - пароль для Вас был сгененирован автоматически. Вы можете изменить его воспользовавшись <a href='#forgot_url#'>Восстановлением пароля</a>.";
$MESS ['SOA_TEMPL_PAY'] = "Оплата заказа";
$MESS ['SOA_TEMPL_PAY_LINK'] = "Если окно с платежной информацией не открылось автоматически, нажмите на кнопку \"Оплатить заказ\".";
$MESS ['SOA_TEMPL_PAY_ACTION'] = "Оплатить заказ";
$MESS ['SOA_PAY_TYPE'] = "Способ оплаты";
$MESS ['SOA_TEMPL_PAY_PDF'] = "Также вы можете скачать счет в формате pdf.";
$MESS ['SOA_TEMPL_PAY_PDF2'] = "Скачать счет";
...
$MESS ['SOA_TEMPL_SUM_QUANTITY_MEASURE'] = "шт";
$MESS ['SOA_TEMPL_SUM_PRICE'] = "Цена";
$MESS ['SOA_TEMPL_SUM_TOTAL'] = "Стоимость";
...
$MESS ['CAPTCHA_REGF_TITLE'] = "Введите слово на картинке";
...
$MESS ['STOF_LOGIN_PROMT'] = "Введите логин и пароль, чтобы продолжить оформление заказа";
...
$MESS ['STOF_NEXT_REGISTER'] = "Зарегистрироваться";
$MESS ['STOF_NAME'] = "Имя";
$MESS ['STOF_LASTNAME'] = "Фамилия";
$MESS ['STOF_MY_PASSWORD'] = "Задать пароль";
$MESS ['STOF_RE_PASSWORD'] = "Повтор пароля";
$MESS ['STOF_SYS_PASSWORD'] = "Сгенерировать пароль";
$MESS ['STOF_EMAIL_NOTE'] = "После регистрации вы получите письмо со ссылкой для подтверждения E-Mail. Регистрация будет завершена только после перехода по этой ссылке.";
$MESS ['SALE_DELIV_PRICE'] = "Стоимость";
$MESS ['SALE_DELIV_PRICE_NEAR'] = "Оценочная стоимость";
...
$MESS ['SOA_TEMPL_NAME'] = "Наименование";
$MESS ['SOA_POPUP_SAVE'] = "Выбрать";
$MESS ['SOA_ORDER_GIVE'] = "Пункты выдачи заказа";
$MESS ['SOA_ORDER_GIVE_TITLE'] = "Пункт выдачи";
$MESS ['SOA_ORDER_PROP_YES'] = "Да";
